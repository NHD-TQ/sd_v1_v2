...
def parse_args():
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="/home/ducnh/pythonProject/only1210/stablediffusion/configs/stable-diffusion/v2-inference.yaml",
        help="path to config which constructs model",
    )
    parser.add_argument(
        "--ckpt",
        type=str,
        default="/home/ducnh/pythonProject/only1210/stablediffusion/checkpoints/512-base-ema.ckpt",
